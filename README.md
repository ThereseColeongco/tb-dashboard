...
It combines [GDP data](https://www.kaggle.com/datasets/zgrcemta/world-gdpgdp-gdp-per-capita-and-annual-growths) from the World Bank (current as of 2020) and [tuberculosis data](https://www.who.int/teams/global-programme-on-tuberculosis-and-lung-health/data) from the WHO (current as of 2025).

Functionality ideas:
- toggle between countries / regions to compare how features correlate (e.g. GDP per capita and TB burden, community support and TB deaths, etc.)
...
- allow users to download filtered datasets as CSV, JSON, or images
